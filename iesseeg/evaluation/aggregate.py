...
MODEL_ORDER = ["handcrafted", "cnn_resnet", "cnn_vit", "biot", "labram", "cbramod", "luna", "eegpt"]
...
def render_latex_table(summary, task, spec, models):
    ...
    column_spec = "l" + "Y" * len(REPORTED_METRICS)
    ...
    lines = [
        ...
        f"  \\label{{{spec['label']}}}",
        f"  \\begin{{tabularx}}{{0.7\\linewidth}}{{{column_spec}}}",
        "    \\toprule",
