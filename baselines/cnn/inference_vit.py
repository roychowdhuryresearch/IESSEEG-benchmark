...
class Brain3DViTInference:
    ...
    def __init__(self, args):
        ...
        # 2) Load the trained model. time_samples must match the
        # epoch_length/sfreq used at training time, or pos_embed is built
        # at the wrong size and load_state_dict/forward will shape-mismatch.
        print(f"Loading model from {args.model_file}...")
        time_samples = int(args.epoch_length * args.sfreq)
        self.model = vit3d(
        ...
        self.model.load_state_dict(torch.load(args.model_file, map_location=self.device, weights_only=False))
    ...
    def run_inference(self):
        ...
        # 30s window); empirically batch_size=128 peaks at ~37GB even without
        # gradients, too close to a 49GB GPU's limit under contention.
        # batch_size=32 peaks at ~9.3GB.
        loader = DataLoader(
            dataset,
            batch_size=32,
            shuffle=False,
